bl_info = {
    ...
    "description": "v0.3.13: 1000MU设计团队专用AI效率插件。兼容Blender 4.2-4.5，修复4.5 shadow_method移除报错。",
    "category": "3D View",
}

# ============================================================================
# v0.3.13 变更摘要（相对 v0.3.12）
#   1. 修复 Blender 4.5 兼容性：material.shadow_method 属性在 4.5 中被移除，
#      改为 hasattr 检测，不存在时静默跳过。blend_method='BLEND' + 透明材质节点
#      本身足以实现透明无阴影效果。兼容 Blender 4.2 - 4.5。
# ============================================================================
